            ...
            children: [
              ...
              GestureDetector(
                onTap: () => Navigator.push(
                    context, MaterialPageRoute(builder: (context) => CariPenghuni())),
                child: Text("+ Tambah Penghuni",
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, penghuniIndex) {
                ...
                final sortedPembayaran = penghuni.riwayatPembayaran
                    .where((item) => item.isLunas == false)
                    .toList();
                    ...
                    Padding(
                      ...
                      child: GestureDetector(
                        onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => DetailPenghuni(data: penghuni))),
                        child: Text(
                          "Lainnya +",
