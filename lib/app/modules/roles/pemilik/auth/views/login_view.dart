...
class _PemilikLoginViewState extends State<PemilikLoginView> {
  ...
  Future login() async {
    ...
    var response = await ApiService().loginPemilik(email: _emailController.text, password: _passController.text);
    setState(() {
      _isLoad = false;
    });
  }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                              onPressed: () async {
                                await login();
                                Navigate.navigatorPush(context, () => BuildPemilikNavigation());
                              },
                          ...
                          Text.rich(
                            TextSpan(
                              children: [
                                ...
                                TextSpan(
                                  recognizer: TapGestureRecognizer()..onTap = () => Navigate.navigatorPush(context, () => RegisterView()),
                                  text: "Daftar",
